...
namespace Vamos_Sergy.Migrations
{
    ...
    [Migration("20240626064045_hero_fight")]
    partial class hero_fight
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vamos_Sergy.Models.Hero", b =>
                {
                    ...
                    b.Property<DateTime?>("QuestStarted")
                        .HasColumnType("datetime2");

                    b.Property<int>("Race")
                        .HasColumnType("int");

                    b.Property<int?>("SelectedQuest")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vamos_Sergy.Models.Items.Shop", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Vamos_Sergy.Models.Items.Equipment", b =>
                {
                    b.HasOne("Vamos_Sergy.Models.Items.Item", "Item")
                        .WithOne("Equipment")
                        .HasForeignKey("Vamos_Sergy.Models.Items.Equipment", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
